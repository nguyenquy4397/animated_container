...
import 'package:animated_container/src/particle.dart';
...
class ConfettiWidget extends StatefulWidget {
  ...
  /// Alignment of point for animation start
  ...
  /// The [createParticlePaths] is optional function that returns list custom Path
  /// needed to generate particles.
  ///
  /// The default function returns rectangular, star, oval path
  final List<Path Function(Size size)>? createParticlePaths;
...
class _ConfettiWidgetState extends State<ConfettiWidget>
  ...
  void initState() {
    ...
    _particleSystem = ParticleSystem(
        ...
        createParticlePaths: widget.createParticlePaths,
        emitterAlignment: widget.alignment);
  ...
  /// init animation: initialize, add listener
  void _initAnimation() {
  ...
  /// handle when controller call play or stop
  void _handleChange() {
    if (widget.confettiController.state == ConfettiControllerState.playing) {
      _startAnimation();
      _startEmission();
  ...
  void _setScreenSize() {
    ...
    if (_screenSize != MediaQuery.of(context).size) {
      _particleSystem.isFullScreen = false;
    } else {
      _particleSystem.isFullScreen = true;
    }
